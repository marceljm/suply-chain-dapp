App = {
    ...
    handleButtonClick: async function (event) {
        ...
        switch (processId) {
            ...
            case 10:
                ...
                break;
            case 11:
                return await App.addAbility(event);
        }
    },
    ...
    buyItem: function (event) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            const walletValue = web3.utils.toWei(String(App.productPrice*2), "ether");
    ...
    addAbility: function (event) {
        event.preventDefault();
        var processId = parseInt($(event.target).data('id'));

        App.contracts.SupplyChain.deployed().then(function (instance) {
            return instance.isFarmer(App.originFarmerID);
        }).then(function (result) {
            console.log('isFarmer', result);
            if (result)
                return;
            App.contracts.SupplyChain.deployed().then(function (instance) {
                instance.addFarmer(App.originFarmerID, { from: App.ownerID, gas: 3000000 });
            }).then(function (result) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            return instance.isDistributor(App.distributorID);
        }).then(function (result) {
            console.log('isDistributor', result);
            if (result)
                return;
            App.contracts.SupplyChain.deployed().then(function (instance) {
                instance.addDistributor(App.distributorID, { from: App.ownerID, gas: 3000000 });
            }).then(function (result) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            return instance.isRetailer(App.retailerID);
        }).then(function (result) {
            console.log('isRetailer', result);
            if (result)
                return;
            App.contracts.SupplyChain.deployed().then(function (instance) {
                instance.addRetailer(App.retailerID, { from: App.ownerID, gas: 3000000 });
            }).then(function (result) {
        ...
        App.contracts.SupplyChain.deployed().then(function (instance) {
            return instance.isConsumer(App.consumerID);
        }).then(function (result) {
            console.log('isConsumer', result);
            if (result)
                return;
            App.contracts.SupplyChain.deployed().then(function (instance) {
                instance.addConsumer(App.consumerID, { from: App.ownerID, gas: 3000000 });
            }).then(function (result) {
